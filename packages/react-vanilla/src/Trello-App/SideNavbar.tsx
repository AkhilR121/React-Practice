...
export function SideNavbar() {
  return (
    <div className="flex w-[19%] flex-col bg-[#1D2125] bg-opacity-95 text-[#85919D]">
      <Header />
      <MainContent />
      <Footer />
    </div>
...
function Header() {
  return (
    <header className="flex items-center justify-between gap-5 border-b-2 border-gray-700">
