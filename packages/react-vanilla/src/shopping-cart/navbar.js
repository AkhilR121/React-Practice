      ...
      <div className="flex w-[100%] items-center justify-between bg-[rgb(241,39,97)] shadow-2xl">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            ...
            <input className="w-96 border-b-2 border-black bg-transparent p-2 px-4 font-serif text-lg font-medium placeholder-slate-700 focus:border-white focus:outline-none" type="text" placeholder="Search Products"/>
          </div>
        </div>
